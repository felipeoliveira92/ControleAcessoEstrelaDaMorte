...
namespace ConroleAcesso.Dao
{
    public abstract class DaoBase: IDisposable
    {
        ...
        protected DaoBase()
        {
            ...
            con = new SqlConnection(@"Provider=SQLOLEDB.1;Integrated Security=SSPI;Persist Security Info=False;User ID=sa;Initial Catalog=EstrelaDaMorte;Data Source=DESKTOP-FELIPE");
        }
